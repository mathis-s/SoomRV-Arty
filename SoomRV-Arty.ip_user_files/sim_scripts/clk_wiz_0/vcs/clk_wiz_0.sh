...
#
# Generated by Vivado on Mon May 01 15:56:30 CEST 2023
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+den2048Mb= +incdir+"$ref_dir/../../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+den2048Mb= +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../SoomRV-Arty.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../SoomRV-Arty.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
