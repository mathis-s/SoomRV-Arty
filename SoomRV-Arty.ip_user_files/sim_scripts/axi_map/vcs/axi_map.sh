...
#
# Script generated by Vivado on Tue Nov 21 20:24:21 CET 2023
...
#
# Usage        : axi_map.sh
#                axi_map.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_map.sh [-reset_run]
#                axi_map.sh [-reset_log]
#                axi_map.sh [-help]
#
...
#                script (type 'axi_map.sh -help' for more information).
#
...
design_libs=(xpm generic_baseblocks_v2_1_1 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_29 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_crossbar_v2_1_30 xil_defaultlib axi_clock_converter_v2_1_28 axi_protocol_converter_v2_1_29 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 xlconstant_v1_1_8)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "axi_map.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_map.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  vlogan -work generic_baseblocks_v2_1_1 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_29 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  vlogan -work axi_data_fifo_v2_1_28 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_30 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/fb47/hdl/axi_crossbar_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../bd/axi_map/ip/axi_map_xbar_0/sim/axi_map_xbar_0.v" \
  "../../../bd/axi_map/ip/axi_map_s00_data_fifo_0/sim/axi_map_s00_data_fifo_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_clock_converter_v2_1_28 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  vlogan -work axi_protocol_converter_v2_1_29 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  vlogan -work xlconstant_v1_1_8 $vlogan_opts +v2k +define+den2048Mb= +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_map xil_defaultlib.glbl -o axi_map_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_map_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="SoomRV-Arty.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key axi_map_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_map_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_map.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_map.sh [-help]\n\
Usage: axi_map.sh [-step]\n\
Usage: axi_map.sh [-lib_map_path]\n\
Usage: axi_map.sh [-reset_run]\n\
Usage: axi_map.sh [-reset_log]\n\
Usage: axi_map.sh [-keep_index]\n\
Usage: axi_map.sh [-noclean_files]\n\n\
