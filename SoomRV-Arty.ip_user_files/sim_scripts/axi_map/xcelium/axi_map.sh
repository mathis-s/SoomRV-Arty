...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/fb47/hdl/axi_crossbar_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  "../../../bd/axi_map/ip/axi_map_xbar_0/sim/axi_map_xbar_0.v" \
  "../../../bd/axi_map/ip/axi_map_s00_data_fifo_0/sim/axi_map_s00_data_fifo_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_clock_converter_v2_1_28 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
  ...
  xmvlog -work xlconstant_v1_1_8 $xmvlog_opts +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/ec67/hdl" +incdir+"../../../../SoomRV-Arty.gen/sources_1/bd/axi_map/ipshared/c2c6" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_map xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_map -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="SoomRV-Arty.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_map_sc.so .tmp_log xcelium_lib waves.shm c.obj)
